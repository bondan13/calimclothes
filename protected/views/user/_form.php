...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
            ...
            'options' => array(
                'minLength' => '3', // min character untuk memulai pencarian  
                'showAnim' => 'fold',
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model, 'kecamatan', array('size' => 32, 'maxlength' => 32, 'class' => 'form-control')); ?>
